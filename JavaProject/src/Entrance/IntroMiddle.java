...
public class IntroMiddle extends JFrame {
	...
	public IntroMiddle(int key, String sub) {
		...
		dbIntro[1].setBounds(230, 285, 280, 100);
		dbIntro[2].setBounds(230, 410, 280, 100);
		...
		event_img.setBounds(160, 480, 190, 200);
		contentPane.add(event_img);

		introTitle = new JLabel("");
		introTitle.setBounds(170, 8, 200, 100);
		Image title = new ImageIcon(this.getClass().getResource("/entIntro.png")).getImage();
